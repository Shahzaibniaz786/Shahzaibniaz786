                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ URL::to('delete-payment-item/'.$item->id.'') }}" onclick="return confirm('Are You Sure To Delete This')" class="btn btn-danger btn-sm">X</a>
                                    </td>
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="payment-item-id" hidden name="payment_id" class="form-control" placeholder="">
