...
<div class="row pl-5 pr-5">
    ...
    <div class="col-md-9">
        <h6>User: {{ Helper::getUserName($expense_data->user_id) }}</h6>
    </div>
    <div class="col-md-3">
...
<section style="margin: 20px;">
    ...
    <table class="table table-sm table-hover table-bordered" style="border: 2px solid black;">
        ...
        <tfoot>
            ...
            <tr class="font-weight-bold">
                <td style="border:1px solid black;"></td>
                <td style="border:1px solid black;">{{ Helper::getAmountInWords($expense_data->total_amount) }}</td>
                <td style="border:1px solid black;">{{ number_format($expense_data->total_amount) }}</td>
                <td style="border:1px solid black;">{{ number_format($expense_data->total_amount) }}</td>
            </tr>
        </tfoot>
    ...
    @section('prepaid_by')
    {{ Helper::getUserName($expense_data->user_id) }}
    @endsection