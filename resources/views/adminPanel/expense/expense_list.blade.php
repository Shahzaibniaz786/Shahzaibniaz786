                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="table-action">
                                        ...
                                        <a href="{{ URL::to('expense_print/'.$exp_res->id.'') }}" target="blank" class="action-icon text-success"> <i class="dripicons-print"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                                @endisset
        ...
        <div class="modal-content">
            ...
            <form action="{{ URL::to('expense-sub') }}" id="expense_form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="exp_name" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter  Name">
                                @error('exp_name')
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="total_amount" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter  Amount">
                                @error('total_amount')
                                <p class="text-danger mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" name="date" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter  Name">
                                @error('date')
                                <p class="text-danger mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="category_id" onchange="fetchSubCategory()" id="category_id">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="disabledSubmitButton(this)" class="btn btn-success">Save changes</button>
                </div>
