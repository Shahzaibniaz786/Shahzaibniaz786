                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-7">
                            <div class="text-sm-end">
                                <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#standard-modal">Add New Supplier</button>
                            </div>
                        </div><!-- end col-->
                    </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="email" class="form-control" placeholder="Supplier Email">
                                    @error('email')
                                    <p class="text-danger mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <p class="text-danger mt-2">{{ $opening_balance }}</p>
                                    @enderror
                                </div>
                            </div>
                        </div>
