        ...
        <div class="tab-pane active" id="home">
            <form action="{{ URL::to('add-make-payment') }}" id="make-payment" method="post">
                ...
                <div class="row">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="text-sm-end">
                                            <a href="{{ URL::to('make-payment-list') }}" class="btn btn-info">Payment List</a>
                                        </div>
                                    </div><!-- end col-->
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="date" name="date" value="{{ date('Y-m-d') }}" class="form-control" placeholder="Bill Date">
                                                    @error('date')
                                            ...
                                            <div class="col-sm-3">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="accountId" required onchange="fetchId('to-account-id','to-account-prev-balance')" class="form-control select2" id="to-account-id">
                                                        <option value="">Choose Account</option>
                                                        @isset($accounts)
                                                        @foreach($accounts as $account_id)
                                                        <option value="{{ $account_id->id }}">{{ $account_id->account_name }}</option>
                                                        @endforeach
                                                        @endisset
                                                    </select>
                                                    @error('accountId')
                                            ...
                                            <div class="col-sm-2">
                                                <div class="mb-3">
                                                    <label for="example-input-normal" class="form-label">Previous Balance</label>
                                                    <input type="text" readonly name="previousBalance" id="to-account-prev-balance" value="{{ old('previousBalance') }}" class="form-control">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="mb-3">
                                                    <label for="example-input-normal" class="form-label">Updated Balance</label>
                                                    <input type="text" readonly name="updatedBalance" value="0" id="updated-balance" class="form-control">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="mb-3">
                                                    <label for="example-input-normal" class="form-label">Total Payments</label>
                                                    <input type="text" readonly name="totalPayments" id="total-payments" value="0" class="form-control" placeholder="Total Payments">
                                                    @error('totalPayments')
                                                    <p class="text-danger mt-2">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="particular" class="form-control" onchange="fetchParticulars('particular','particularId','particular-balance')" id="particular">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="mb-3">
                                                    <label for="example-input-normal" class="form-label">Select Account</label>
                                                    <select name="particularId" onchange="fetchParticularBalnce('particular','particularId','particular-balance')" class="form-control" id="particularId">
                                                        <option value="-1">Select One</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <div class="mb-3">
                                                    <label for="example-input-normal" class="form-label">
                                                        Balance</label>
                                                    <input type="number" readonly id="particular-balance" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <div class="mb-3">
                                                    <label for="example-input-normal" class="form-label">Payments</label>
                                                    <input type="number" id="payment" name="payment" class="form-control" placeholder="Payments">
                                                    @error('payment')
                                                    <p class="text-danger mt-2">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="mb-3">
                                                    <button class="btn btn-success" type="button" style="margin-top: 1.8rem;" onclick="addToCart('particular','particularId','payment','remarks','tableBody')">Add Payment</button>
                                                </div>
                                            </div>
                    ...
                    <div class="col-md-12">
                        <button type="button" onclick="disabledSubmitButton('make-payment')" id="sub_make_payment" class="btn btn-success">Submit</button>
                    </div>
                </div>
            </form>
        </div>
        <div class="tab-pane show " id="profile">
            <form action="{{ URL::to('add-received-payment') }}" id="receive-payment" method="post">
                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="text-sm-end">
                                            <a href="{{ URL::to('receive-payment-list') }}" class="btn btn-secondary">Received Payment List</a>
                                        </div>
                                    </div><!-- end col-->
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="mb-3">
                                                    <label for="example-input-normal" class="form-label"> Select Account</label>
                                                    <select name="accountId" required onchange="fetchId('from-account-id','from-account-prev-balance')" class="form-control select2" id="from-account-id">
                                                        <option value="">Chose One</option>
                                                        @isset($accounts)
                                                        @foreach($accounts as $account_id)
                                                        <option value="{{ $account_id->id }}">{{ $account_id->account_name }}</option>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="mb-3">
                                                    <label for="example-input-normal" class="form-label">Previous Balance</label>
                                                    <input type="text" readonly name="previousBalance" id="from-account-prev-balance" value="{{ old('previousBalance') }}" class="form-control" placeholder="Total Bill">
                                                    @error('previousBalance')
                                                    <p class="text-danger mt-2">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="mb-3">
                                                    <label for="example-input-normal" class="form-label">Updated Balance</label>
                                                    <input type="text" readonly id="from-updated-balance" name="updatedBalance" value="0" class="form-control" placeholder="Total Bill">
                                                    @error('updatedBalance')
                                                    <p class="text-danger mt-2">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="mb-3">
                                                    <label for="example-input-normal" class="form-label">Total Payments</label>
                                                    <input type="text" id="from-total-payments" readonly name="totalPayments" value="0" class="form-control" placeholder="Total Bill">
                                                    @error('totalPayments')
                                                    <p class="text-danger mt-2">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="mb-3">
                                                    <label for="example-input-normal" class="form-label">Select Particular</label>
                                                    <select name="particular" class="form-control" onchange="fetchParticulars('particularFrom','particularIdFrom','particular-balance-from')" id="particularFrom">
                                                        <option value="">Chose One</option>
                                                        <option value="Party" party-type="Marka">Marka</option>
                                                        <option value="Party" party-type="Driver">Driver</option>
                                                        <option value="Party" party-type="Customer">Customer</option>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="mb-3">
                                                    <label for="example-input-normal" class="form-label">Select Account</label>
                                                    <select name="particularId" onchange="fetchParticularBalnce('particularFrom','particularIdFrom','particular-balance-from')" class="form-control" id="particularIdFrom">
                                                        <option value="-1">Select One</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <div class="mb-3">
                                                    <label for="example-input-normal" class="form-label">Balance</label>
                                                    <input type="number" readonly id="particular-balance-from" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-sm-2">
                                                <div class="mb-3">
                                                    <label for="example-input-normal" class="form-label">Payments</label>
                                                    <input type="number" id="paymentFrom" name="payment" class="form-control" placeholder="Payments">
                                                    @error('payment')
                                                    <p class="text-danger mt-2">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="mb-3">
                                                    <label for="example-input-normal" class="form-label">Remarks</label>
                                                    <input type="text" id="remarksFrom" name="remarks" class="form-control" placeholder="Remarks">
                                                    @error('remarks')
                                                    <p class="text-danger mt-2">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-sm-2">
                                                <div class="mb-3">
                                                    <button class="btn btn-success" type="button" style="margin-top: 1.8rem;" onclick="addToCart('particularFrom','particularIdFrom','paymentFrom','remarksFrom','tableBodyFrom')">Add Payment</button>
                                                </div>
                                            </div>
                    ...
                    <div class="col-md-12">
                        <button type="button" onclick="disabledSubmitButton('receive-payment')" class="btn btn-success">Submit</button>
                    </div>
                </div>
            </form>
        </div>
...
<script>
    ...
    function getAccountBalance(id, displayId) {
        ...
        if (displayId == 'to-account-prev-balance') {
            ...
            calculateTotalPayment('tableBodyFrom', 'from-account-prev-balance', 'from-updated-balance', 'from-total-payments')
        }
    }
