                                ...
                                <tr>
                                    ...
                                    <td class="table-action">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <a href='{{ URL::to("view-receive-payment-details/{$receivedPayment->id}") }}' class="btn btn-info btn-sm action-icon text-white"> <i class="mdi mdi-eye"></i></a>
                                            <button onclick="openUpdatePaymentModel({{ $receivedPayment->id }})" class="btn btn-success btn-sm"><i class="mdi mdi-clipboard-edit-outline"></i></button>
                                            <a href='{{ URL::to("print-payment-received-voucher/{$receivedPayment->id}") }}' class="btn btn-info btn-sm action-icon text-white"> <i class="dripicons-print"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="payment-id" hidden name="payment_id" class="form-control" placeholder="">
                                    <input type="date" id="payment-date" name="date" class="form-control" placeholder="">
                                    @error('date')
                            ...
                            <div class="col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="" id="total-payments" readonly class="form-control" placeholder="Total Payments">
