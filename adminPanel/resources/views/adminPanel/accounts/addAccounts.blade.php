                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="table-action">
                                                <a href="javascript:void(0)" class="action-icon text-success" data-id="{{ $account->id }}" data-bs-toggle="modal" data-bs-target="#edit-modal"> <i class="mdi mdi-square-edit-outline"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                        @endisset
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <div class="mb-3">
                                ...
                                <input type="text" name="account_name" class="form-control" placeholder="Accounts Name">
                                @error('account_name')
                        ...
                        <div class="col-sm-12">
                            <div class="mb-3">
                                ...
                                <input type="text" name="openingBalance" class="form-control" value="0" placeholder="Opening Balance">
                ...
                <div class="modal-body">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-12">
                            <div class="mb-3">
                                <label for="example-input-normal" class="form-label">Opening Balance</label>
                                <input type="text" id="openingBalance" name="openingBalance" readonly class="form-control" value="0">
                                @error('openingBalance')
                                <p class="text-danger mt-2">{{ $message }}</p>
                                @enderror
                            </div>
...
<!-- cash deposit modal -->
<div id="cash-deposit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-12">
                            <div class="mb-3">
                                ...
                                <input type="text" name="depositBy" class="form-control" placeholder="Deposited By">
                                @error('depositBy')
                                <p class="text-danger mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="col-sm-12">
                            <div class="mb-3">
                                ...
                                <input type="text" name="depositAmount" class="form-control" placeholder="Amount">
                                @error('depositAmount')
                                <p class="text-danger mt-2">{{ $message }}</p>
                                @enderror
                            </div>
