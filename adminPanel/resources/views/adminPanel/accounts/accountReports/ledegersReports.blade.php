                        ...
                        <div class="col-md-12">
                            <ul class="nav nav-pills bg-nav-pills nav-justified mb-3">
                                ...
                                <li class="nav-item">
                                    <a href="#agent_ledeger" data-bs-toggle="tab" aria-expanded="false" class="nav-link rounded-0">
                                        ...
                                        <span class="d-none d-md-block">Party Ledger</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="#supplier_customer_list" data-bs-toggle="tab" aria-expanded="true" class="nav-link rounded-0">
                                        <i class="mdi mdi-account-circle d-md-none d-block"></i>
                                        <span class="d-none d-md-block">Supplier Customer List</span>
                                    </a>
                                </li>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="date_wise_cash_ledeger">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h5>Date Wise Cash Account Ledeger</h5>
                                        </div>
                                        <div class="col-md-12">
                                ...
                                <div class="tab-pane" id="agent_ledeger">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <form action="{{ URL::to('print-party-ledeger') }}" target="blank" method="post">
                                                @csrf
                                                <div class="row mt-3">
                                                    <div class="col-sm-3">
                                                        <div class="mb-3">
                                ...
                                <div class="tab-pane" id="date_wise_agent_ledeger">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h5>Date Wise Party Ledeger</h5>
                                        </div>
                                        <div class="col-md-12">
                                            <form action="{{ URL::to('date-wise-party-ledeger') }}" target="blank" method="post">
                                                @csrf
                                                <div class="row mt-3">
                                                    <div class="col-sm-3">
                                                        <div class="mb-3">
                                ...
                                <div class="tab-pane" id="supplier_customer_list">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h5>Supplier Customer List</h5>
                                        </div>
                                        <div class="col-md-12">
                                            <form action="{{ URL::to('supplier-customer-list-print') }}" target="blank" method="post">
                                                @csrf
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="mb-3">
                                                            <label for="example-input-normal" class="form-label">Select Supplier</label>
                                                            <select name="supplier_id" onchange="fetchSupplierCustomers('supplier_id','particularId')" class="form-control select2" id="supplier_id">
                                                                <option value="-1">Select One</option>
                                                                @isset($suppliers)
                                                                @foreach($suppliers as $supplier)
                                                                <option value="{{ $supplier->id }}">{{ $supplier->name }}</option>
