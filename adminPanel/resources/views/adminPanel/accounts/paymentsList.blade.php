                                ...
                                <tr>
                                    ...
                                    <td class="table-action">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <a href='{{ URL::to("view-payment-details/{$makePayment->id}") }}' class="btn btn-primary btn-sm action-icon text-white"> <i class="mdi mdi-eye"></i></a>
                                            <a href='{{ URL::to("print-payment-voucher/{$makePayment->id}") }}' class="btn btn-info btn-sm action-icon text-white"> <i class="dripicons-print"></i></a>
                                            <button onclick="openUpdatePaymentModel({{ $makePayment->id }})" class="btn btn-success btn-sm"><i class="mdi mdi-clipboard-edit-outline"></i></button>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
