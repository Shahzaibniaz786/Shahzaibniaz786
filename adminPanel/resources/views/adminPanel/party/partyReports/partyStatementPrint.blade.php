                    ...
                    <tr>
                        ...
                        <td style="border:1px solid black;">{!! $desc !!}
                            ...
                            if (isset($ledgerItem->purchase_qty)) {
                                ...
                                if ($party->type == 'Marka') {
                            ?>
                                    <h6>Order ID: {{ $order->id }} | Maraka: {{ $order->maraka->name }} | Product: {{ $productType }}| Qty: {{ number_format($order->purchase_qty) }} | Purchase Rate: {{ number_format($order->purchase_rate) }} </h6>
                                ...
                                ?>
                                    <h6>Order ID: {{ $order->id }} | Maraka: {{ $order->maraka->name }} | Product: {{ $productType }}| Qty: {{ number_format($order->purchase_qty) }} | Carriage Amount: {{ number_format($order->carriage_amount) }}</h6>
                                ...
                                if ($party->type == 'Customer') {
                                ?>
                                    <h6>Supplier: {{ $order->supplier->name }} | Order ID: {{ $order->id }} | Maraka: {{ $order->maraka->name }} | Product: {{ $productType }}| Qty: {{ number_format($order->purchase_qty) }} | Sale Price: {{ number_format($order->sale_rate) }}</h6>
            ...
            <table class="table table-sm table-hover table-bordered" style="border: 2px solid black;">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="border:1px solid black;text-align:right">
                            ...
                            if ($party->opening_balance >= 0) {
                                echo number_format($party->opening_balance);
                            } else {
                                echo "[ " . number_format($party->opening_balance) . " ]";
                            }
                            ?>
                    ...
                    <tr>
                        ...
                        <td style="border:1px solid black;text-align:right">
                            <?php
                            $balance = $party->opening_balance +  ($total_credit - $total_debit);
                            if ($balance >= 0) {
