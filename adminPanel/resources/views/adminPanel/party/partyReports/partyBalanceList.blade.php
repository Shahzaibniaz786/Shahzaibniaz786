...
@section('content')
<h3 style="margin-top:40px;">{{ $request['particularType'] }} Wise Payable & Receivable </h3>
            ...
            <table class="table table-sm table-hover table-bordered" style="border: 2px solid black;">
                ...
                <tbody style="border: 2px solid black;">
                    ...
                    <tr>
                        ...
                        <td style="border:1px solid black;">
                            @if($party->balance < 0) {{ number_format($party->balance) }} @php $totalReceiablePayable +=$party->balance;
                                @endphp
                                @endif </td>
                    </tr>
