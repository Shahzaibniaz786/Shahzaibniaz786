                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="nav nav-pills bg-nav-pills nav-justified mb-3">
                                ...
                                <li class="nav-item">
                                    <a href="#agent_ledeger" data-bs-toggle="tab" aria-expanded="false" class="nav-link rounded-0 active">
                                ...
                                <li class="nav-item">
                                    <a href="#cash_account" data-bs-toggle="tab" aria-expanded="true" class="nav-link rounded-0">
                                        <i class="mdi mdi-home-variant d-md-none d-block"></i>
                                        <span class="d-none d-md-block">Cash Account Statement</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="#cash_account_datewise" data-bs-toggle="tab" aria-expanded="true" class="nav-link rounded-0">
                                        <i class="mdi mdi-home-variant d-md-none d-block"></i>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane show active" id="agent_ledeger">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <form action="{{ URL::to('generate-party-statement') }}" target="blank" method="post">
                                                @csrf
                                                <div class="row mt-3">
                                                    <div class="col-sm-3">
                                                        <div class="mb-3">
                                ...
                                <div class="tab-pane" id="date_wise_agent_ledeger">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <form action="{{ URL::to('date-wise-party-statement') }}" target="blank" method="post">
                                                @csrf
                                                <div class="row mt-3">
                                                    <div class="col-sm-3">
                                                        <div class="mb-3">
                                                            <label for="example-input-normal" class="form-label">Select Particular</label>
                                                            <select name="particular" class="form-control" onchange="fetchParticulars('particular-date-wise','particularIdDateWise')" id="particular-date-wise">
                                                                <option value="">Chose One</option>
                                                                <option value="Party" party-type="Marka">Marka</option>
                                                                <option value="Party" party-type="Driver">Driver</option>
                                                                <option value="Party" party-type="Customer">Customer</option>
                                                    ...
                                                    <div class="col-sm-3" id="supplier-div-datewise" style="display: none;">
                                                        <div class="mb-3">
                                                            <label for="example-input-normal" class="form-label">Select Supplier</label>
                                                            <select name="" onchange="fetchSupplierCustomers('supplier_id_dateWise','particularIdDateWise')" class="form-control select2" id="supplier_id_dateWise">
                                                                <option value="-1">Select One</option>
                                                                @isset($suppliers)
                                                                @foreach($suppliers as $supplier)
                                                                <option value="{{ $supplier->id }}">{{ $supplier->name }}</option>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <select name="partyId" onchange="fetchParticularBalnce('particular','particularId','particular-balance')" class="form-control" id="particularIdDateWise">
                                                                <option value="-1">Select One</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                ...
                                <div class="tab-pane" id="cash_account">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <form action="{{ URL::to('generate-account-statement') }}" target="blank" method="post">
                                                @csrf
                                                <div class="row mt-3">
                                                    <div class="col-md-10">
                                ...
                                <div class="tab-pane" id="cash_account_datewise">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <form action="{{ URL::to('generate-account-statement-datewise') }}" target="blank" method="post">
                                                @csrf
                                                <div class="row mt-3">
                                                    <div class="col-md-4">
                                                        <label for="exampleInputEmail1" class="form-label">Select Account</label>
